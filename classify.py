...
if __name__ == '__main__':
    ...
    for part in parts:
        ...
        if not domain_exists:
            ...
            part_conv_data_df[KEY_COLS + list(DomainClassification.model_fields)].to_parquet(domain_path, index=False)
        else:
        ...
        if not intent_exists:
            ...
            part_conv_data_df[KEY_COLS + list(IntentClassification.model_fields)].to_parquet(intent_path, index=False)
        else:
        ...
        if not task_exists:
            ...
            part_conv_data_df[KEY_COLS + list(InteractionAnswer.model_fields)].to_parquet(task_path, index=False)
        else:
